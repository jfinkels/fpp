...
\todo{Define slices of parameterized problem.}
...
%% \begin{proof}
  ...
  \item $\alpha = 2c$,
  \item $\beta = c$,
  \item $f$ is the function that squares the value of its input,
  \item $g$ is the identity function,
  \item $k = t / n^c$.
  \end{itemize}
