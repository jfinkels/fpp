...
\newcommand{\pgrouprank}{p\textnormal{-}\textsc{Group Rank}}
...
\todo{Problems based on NP-complete problems, like vertex cover, etc.}

The positive linear programming is $\P$-complete, but has FNCAS, so is in FPP.
...
Let $\pgrouprank$ denote the natural parameterization of $\textsc{Group Rank}$.
