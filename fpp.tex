...
Let $\pFSAT$ denote the weighted Boolean formula satisfiability problem.
...
Unfortunately, the proof of \autocite[Theorem~3.6]{est15} does not translate to the setting of bounded depth circuit satisfiability.
Their reduction would yield a circuit of depth greater than polylogarithmic in the number of inputs.
